...
<body>
    <div class="login-container animated fadeInDown">
        <div class="loginbox bg-white">
            <div class="loginbox-title">数据字典管理系统</div>
            <div class="loginbox-social">
                <div class="social-title ">国信证券电子商务总部数据组</div>
                <div class="social-buttons">
                    <a  class="button-guosen">
                        <i class="social-icon fa fa-guosen"></i>
                    </a>
                </div>
            </div>
            <div class="loginbox-or">
                <div class="or-line"></div>
                <div class="or">Login in</div>
            </div>
