...
CREATE TABLE `dictionary` (
  `dkey` varchar(50) NOT NULL DEFAULT '' COMMENT '字段',
  `dvalue` varchar(50) NOT NULL DEFAULT '' COMMENT '含义',
  `dtable` varchar(50) DEFAULT NULL COMMENT '所在表',
...
INSERT INTO `user` VALUES (1,'admin','admin','25dffd9de2aeee927453c65fd006ee24',1,1);
...
-- Dump completed on 2015-10-02  0:23:57
